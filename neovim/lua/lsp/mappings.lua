...
function M.init(client, bufnr)
  ...
  -- code actions
  buf_map(bufnr, 'n', 'ga', '<cmd>lua require("cosmic-ui").code_actions()<cr>')
  buf_map(bufnr, 'v', 'ga', '<cmd>lua require("cosmic-ui").range_code_actions()<cr>')

  -- formatting
  buf_map(bufnr, 'n', '<leader>gf', '<cmd>lua vim.lsp.buf.format()<cr>')
