...
gls.right = {
    ...
    },
    {
        DiagnosticError = {
            ...
            highlight = { colors.bg, colors.error },
            icon = '  ' .. icons.error .. ' ',
            condition = condition.buffer_not_empty,
        },
    },
    ...
    },
    {
        DiagnosticWarn = {
            ...
            highlight = { colors.bg, colors.warn },
            icon = '  ' .. icons.warn .. ' ',
            condition = condition.buffer_not_empty,
        },
    },
    ...
    },
    {
        DiagnosticHint = {
            ...
            icon = '  ' .. icons.hint .. ' ',
            highlight = { colors.bg, colors.hint },
            condition = condition.buffer_not_empty,
        },
    },
    {
